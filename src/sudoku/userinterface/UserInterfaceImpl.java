...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private static final int WINDOW_Y = 732;
    private static final int WINDOW_X = 668;
    private static final int BOARD_PADDING = 50;
    private static final int BOARD_X_ABD_Y = 576;
    ...
    private void drawSudokuBoard(Group root) {
        ...
        boardBackground.setWidth(BOARD_X_ABD_Y);
        boardBackground.setHeight(BOARD_X_ABD_Y);
